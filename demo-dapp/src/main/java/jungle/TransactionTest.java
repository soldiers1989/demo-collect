...
import contracts.SuperConductToken;
...
public class TransactionTest {
	...
	private final static BigInteger sss_gas_price = new BigInteger("5680000000");
	private final static BigInteger sss_gas_limit = new BigInteger("60000");
	private final static String sss_private_key = "";
	private final static String sss_contract_addr = "0xe0E0BaC8cD3E868804B5B4bb6688bA192d1FA478";
	...
	public static void main(String[] args) {
		try {
			...
			//WalletUtils.
			Credentials credentials = Credentials.create(sss_private_key);
    ...
    public static void sendRawTransaction(Web3j web3j, Credentials credentials) {
        ...
        TransactionManager txManager = new SssRawTransactionManager(web3j, credentials);
        SuperConductToken token = SuperConductToken.load(sss_contract_addr, web3j, txManager ,sss_gas_price, sss_gas_limit);
        try {
			TransactionReceipt receip = token.transferOwnership("0x940EF62e3abb8ed13dC630112c633142A4c484cB").send();
